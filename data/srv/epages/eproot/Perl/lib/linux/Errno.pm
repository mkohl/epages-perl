...
"i686-linux-thread-multi-64int-2.6.32-431.el6.i686" or
        die "Errno architecture (i686-linux-thread-multi-64int-2.6.32-431.el6.i686) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
