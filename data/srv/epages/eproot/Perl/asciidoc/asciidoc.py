...
# Constants
# ---------
APP_FILE = '/srv/epages/eproot/Perl/asciidoc/asciidoc.py' # This file's full path.
APP_DIR = '/srv/epages/eproot/Perl/asciidoc' # This file's directory.
USER_DIR = None             # ~/.asciidoc
# Global configuration files directory (set by Makefile build target).
CONF_DIR = '/srv/epages/eproot/Perl/asciidoc/etc'
